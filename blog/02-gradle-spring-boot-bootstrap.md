...
이건 처음부터 있던 구조는 아닙니다.
결정 로그 [phase16_github_actions_ci.md](../docs/decisions/phase16_github_actions_ci.md) 와 [phase44_tagged_ci_readiness_and_hiring_pack.md](../docs/decisions/phase44_tagged_ci_readiness_and_hiring_pack.md) 를 보면,
