...
## 0) 현재 상태
- 상태: `DONE`
- 기준 시각: `2026-04-18 01:32 KST`
- 반영 브랜치: `codex/add-deployment-assets`
- 원격 동기화: `965770d (HEAD) == origin/codex/add-deployment-assets`
- 워킹 트리: clean
- 비고: 배포 가이드/배포 자산 추가와 CI smoke fix까지 원격 반영이 끝났고, 이 계획서는 완료 기록으로 유지한다.
