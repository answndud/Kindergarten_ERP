...
- 2026-01-17: 승인 화면 버튼 동작 정리(교사 승인/취소/거절 액션 수정) 및 알림 드롭다운 액션 확장
- 2026-01-17: 승인/취소 모달에 신청자/유치원명 표시로 액션 UX 정리
- 2026-01-17: 대시보드 승인 대기 카드가 실제 대기 목록 수를 반영하도록 연동
- 2026-01-23: 승인/거절 알림 링크를 승인 대기 화면으로 통일
- 2026-02-14: `/kindergarten/select`에서 교사 유치원 선택 시 `POST /api/v1/kindergarten-applications`로 실제 지원 신청 연결
